...
{
    /// <summary>
    /// Interaction logic for NhapTheoThang.xaml
    /// </summary>
    public partial class NhapTheoThang : Window
    {
        public NhapTheoThang()
        {
            InitializeComponent();
        ...
        public void loadData(string begindate, string enddate, int ct)
        {
            ...
            string sql = "exec SP_RP_NHAP_HANG @begin = N'" + begindate + "', @end = N'" + enddate + "', @ct = " + ct;
