...
{
    /// <summary>
    /// Interaction logic for THNXNgay.xaml
    /// </summary>
    public partial class THNXNgay : Window
    {
        public THNXNgay()
        {
            InitializeComponent();
        ...
        public void loadData(string begindate, string enddate, int ct)
        {
            ...
            QLVTDataSet.THNX_NGAYDataTable th = new QLVTDataSet.THNX_NGAYDataTable();


            string sql = "exec SP_THNX_THEO_NGAY @begin = N'" + begindate + "', @end = N'" + enddate + "', @ct = " + ct;
            ...
            _reportViewer.LocalReport.ReportEmbeddedResource = "WpfApp2.ReportTemplate.RDLC.TongHopNhapXuatNgay.rdlc";
